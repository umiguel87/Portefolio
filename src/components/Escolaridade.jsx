...
const escolaridade = [
  {
    ...
    cursoEn: 'Higher Professional Technical Course in Information Systems Technology',
    periodo: '2024 — até ao momento',
    periodoEn: '2024 — present',
    ...
    descricaoEn: 'Short-cycle higher education (level 5 EQF). Practice-oriented training for the job market.',
    logo: logoIpvc,
    link: null,
  },
  {
